            ...
            >
              <defs>
                ...
                <linearGradient
                  ...
                  xlinkHref="#Unbenannter_Verlauf_3"
                ></linearGradient>
                <linearGradient
                ...
                <linearGradient
                  ...
                  xlinkHref="#Unbenannter_Verlauf_7"
                ></linearGradient>
                <linearGradient
                ...
                <linearGradient
                  ...
                  gradientTransform="matrix(1 0 0 -1 -21.5 177.3)"
                  xlinkHref="#Unbenannter_Verlauf_2"
                ></linearGradient>
                <linearGradient
                ...
                ></linearGradient>
                <linearGradient
                  id="Unbenannter_Verlauf_912"
                  x1="37.8"
                  x2="262"
                  y1="92.55"
                  y2="92.55"
                  data-name="Unbenannter Verlauf 912"
                  gradientTransform="matrix(1 0 0 -1 -37.8 190.4)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <radialGradient
                  id="Unbenannter_Verlauf_673"
                  cx="135.14"
                  cy="78.35"
                  r="70"
                  data-name="Unbenannter Verlauf 673"
                  gradientTransform="matrix(1.12 0 0 -1.12 -39.26 217.5)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <linearGradient
                  id="Unbenannter_Verlauf_668"
                  x1="170.4"
                  x2="245.7"
                  y1="-0.9"
                  y2="-0.9"
                  data-name="Unbenannter Verlauf 668"
                  gradientTransform="matrix(1 0 0 -1 -21.5 177.3)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <linearGradient
                  id="Unbenannter_Verlauf_668-2"
                  x1="189.67"
                  x2="244.87"
                  y1="15.7"
                  y2="15.7"
                  xlinkHref="#Unbenannter_Verlauf_668"
                ></linearGradient>
                <linearGradient
                  id="Unbenannter_Verlauf_668-3"
                  x1="22.1"
                  x2="77.6"
                  y1="15.5"
                  y2="15.5"
                ...
                ></linearGradient>
                <linearGradient
                  id="Unbenannter_Verlauf_912-2"
                  x1="133.86"
                  x2="189.66"
                  y1="15.2"
                  y2="15.2"
                  gradientTransform="matrix(1 0 0 -1 -21.5 177.3)"
                  xlinkHref="#Unbenannter_Verlauf_912"
                ></linearGradient>
                <linearGradient
                  id="Unbenannter_Verlauf_912-3"
                  x1="77.6"
                  x2="133.87"
                  y1="15.2"
                  y2="15.2"
              ...
              <g id="dark" opacity={`${props.darkTheme ? "1" : "0"}`}>
                <path
