...
const ThreejsRender = () => {
  return (
    <Suspense fallback={<h3>Loading...</h3>}>
      <Canvas camera={{ fov: 75, near: 0.1, far: 500, position: [-2, 2, 3] }}>
        <ambientLight />
        ...
        {/* <pointLight position={[2, 1, 4]} intensity={2} color={0xb04d76} /> */}
        {/* <pointLight position={[2, 1, 4]} intensity={20} color={0xa45a9a} /> */}
