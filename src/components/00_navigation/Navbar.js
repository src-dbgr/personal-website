            ...
            >
              <defs>
                <radialGradient
                  ...
                  cy="127.01"
                  r="125.01"
                  gradientTransform="matrix(-0.16, -0.99, -1.19, 0.19, 295.09, 224.61)"
                  gradientUnits="userSpaceOnUse"
                >
                  <stop
                    id="circle_gradient_first_child"
                    offset="0"
                    stop-color="#9a988e"
                  />
                  <stop
                    id="circle_gradient_last_child"
                    offset="1"
                    stop-color="#51656a"
                  />
                </radialGradient>
                <linearGradient
                  ...
                  x2="163.5"
                  y2="301.94"
                  gradientTransform="matrix(1, 0, 0, -1, 0, 252.04)"
                  gradientUnits="userSpaceOnUse"
                >
              ...
              <path
                id="circle_nav"
                data-name="circle nav"
                d="M125.3,0C191.9-1.3,249.9,56,250,124.8S191.9,251.2,123,250C55.6,248.8.5,193.4,0,124.8S58.4-1.7,125.3,0Z"
              ...
              <polygon
                ...
                points="250 0 125 250 0 0 250 0"
